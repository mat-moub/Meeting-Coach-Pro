...
const CoachChat: React.FC<CoachChatProps> = ({ advices, t }) => {
    ...
    <div className="flex flex-col h-full glass-panel rounded-xl overflow-hidden shadow-2xl">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-4 scroll-smooth">
        {advices.length === 0 ? (
          ...
          advices.map((advice) => (
            <div key={advice.id} className="group relative">
              ...
              <div className="pl-4">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs text-slate-500 italic">— {advice.speaker}</span>
                </div>
